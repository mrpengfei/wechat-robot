...
namespace Wechat.API
{
    public class WechatAPIService
    {
        ...
        public string GetNewQRLoginSessionID()
        {
            ...
            string url = "https://login.weixin.qq.com/jslogin?appid=wx782c26e4c19acffb&fun=new&lang=zh_CN&_="+getTimestamp(DateTime.Now);
            ...
            if (login_result.Contains("window.code=201")) //已扫描 未登录
            {
            ...
            } else if (login_result.Contains("window.code=200"))  //已扫描 已登录
              {
                ...
                result.redirect_uri = login_redirect_url;
                  ...
                  this.baseUrl = login_redirect_url.Substring(0, login_redirect_url.LastIndexOf("/"));
              }
        ...
        /// 初始化
        /// </summary>
        /// <param name="pass_ticket">The pass_ticket</param>
        /// <param name="baseReq">The baseReq</param>
        ...
        {
            string url = this.baseUrl+ "/webwxinit?r={0}&pass_ticket={1}";
        ...
        {
            string url = this.baseUrl+"/webwxgetcontact?pass_ticket={0}&r={1}&seq=0&skey={2}";
        ...
        {
            string url = this.baseUrl+"/webwxsync?sid={0}&skey={1}&lang=zh_CN&pass_ticket={2}";
        ...
        {
            string url = this.baseUrl+"/webwxstatusnotify?lang=zh_CN&pass_ticket=" + pass_ticket;
        ...
        {
            string url = this.baseUrl+"/webwxsendmsg?sid={0}&r={1}&lang=zh_CN&pass_ticket={2}";
