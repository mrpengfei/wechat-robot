    ...
    public partial class LoginForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            wc.OnRecvMsg = (msg) => {
                if (msg.ToUserName == wc.CurrentUser.UserName && !msg.FromUserName.StartsWith("@@")) {
                    ...
                    //string rep = "";
                    //if ("hello".Equals(msg.Content,StringComparison.OrdinalIgnoreCase)) {
                    //    rep = "你好，请说中文！";
                    //}else if (msg.Content == "哈哈") {
                    //    rep = "哈哈，你是逗逼吗？笑啥？";
                    //}else{
                    //    rep = "还能好好聊天吗？我都不知道你在说啥？";
                    //}
                    var rep = TuLingRobot.Answer(msg.Content);
        ...
        private void button_send_msg_txt_Click(object sender, EventArgs e)
        {
            ...
            if (args.Length == 2) {
                ...
                if (wc.SendMsg(userName, textBox_msg_text.Text))
                {
                      textBox_msg_text.Clear();
                }
